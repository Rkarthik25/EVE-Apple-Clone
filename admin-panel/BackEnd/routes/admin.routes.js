...
bcrypt.hash(req.body.password,5,async(err,hash)=>{
    if(err){
        ...
        await newAdmin.save()
        res.send("We have received your details. We will verify your details and get back to you asap")
        console.log("We have received your details. We will verify your details and get back to you asap")
    }
})
}
}
