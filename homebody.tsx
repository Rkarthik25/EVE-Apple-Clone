...
const video = require("../HomeBody/Videos/videoplayback.mp4");
...
function HomeBody() {
  return (
    <div id="homepage_container">
      ...
      <div>
        <h1 style={{ color: "white" }}>iPhone 14 Pro</h1>
        <h4>Pro.Beyond.</h4>
        <button
          style={{
            border: "1px solid grey",
        ...
        <div>
          <img
            src="https://www.apple.com/in/iphone-14/images/overview/hero/hero_iphone_14__esmpw7gjv46e_medium.jpg"
            alt="error"
          />
          <img
            src="https://www.apple.com/in/iphone-14/images/overview/hero/hero_iphone_14_plus__fra3gmuj0aum_medium.jpg"
            alt="error"
          />
        </div>
      </div>
      ...
      <div id="mid_body_divs">
        ...
        <div>
          <h2>iPad</h2>
          <h4>Lovabel. Drawabale. Magical.</h4>
          <div>
            <button>Learn more &#62; </button>
            <button>Buy &#62;</button>
          </div>
