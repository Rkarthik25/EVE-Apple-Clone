    ...
    <div className="payment">
      ...
      <div className="payment-container">
        <div className="payment-optionContainer">
          <div className="payment-headerContainer">
            <h1 className="payment-headerTitle">How do you want to pay?</h1>
          </div>

          <div className="payment-options">
            <div className="payment-infull">
              <div className="infull-header">
                <h2 className="infull-title">Pay in full.</h2>
              </div>
              <div className="infull-debitcard">
                <Button
                  onClick={onOpen}
                  w="50%"
                  pt={10}
                  ...
                  <p style={{ fontSize: "12px" }}>
                    Visa, Mastercard, AMEX, Discover, Diners Club, RuPay
                  </p>
                </Button>
                ...
                <Modal isOpen={isOpen} onClose={onClose}>
                  <ModalOverlay />
                  <ModalContent>
                    <ModalHeader>Credit / Debit Card</ModalHeader>
                    <ModalCloseButton />
                    <ModalBody>
                      ...
                      <div
                        className="form-textbox contact-content"
                        style={{
                          display: "flex",
                          flexDirection: "row",
            ...
            <div className="payment-overtime"></div>
          </div>
        </div>
